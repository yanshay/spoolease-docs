"use strict";
(self["webpackChunkspoolease_docs"] = self["webpackChunkspoolease_docs"] || []).push([[8103],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_10_components_index_mdx_ce3_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-10-components-index-mdx-ce3.json
const site_docs_10_components_index_mdx_ce3_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/index","title":"Required Components","description":"Grab your wallet — it’s time to treat yourself!","source":"@site/docs/10-components/index.mdx","sourceDirName":"10-components","slug":"/components/","permalink":"/docs/components/","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Required Components"},"sidebar":"documentationSidebar","previous":{"title":"Welcome","permalink":"/docs/welcome"},"next":{"title":"Console Components","permalink":"/docs/components/console"}}');
