"use strict";
(self["webpackChunkspoolease_docs"] = self["webpackChunkspoolease_docs"] || []).push([[8505],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_20_build_setup_index_mdx_f5e_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-20-build-setup-index-mdx-f5e.json
const site_docs_20_build_setup_index_mdx_f5e_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"build-setup/index","title":"Build & Setup","description":"Let the fun begin!","source":"@site/docs/20-build-setup/index.mdx","sourceDirName":"20-build-setup","slug":"/build-setup/","permalink":"/docs/build-setup/","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Build & Setup"},"sidebar":"documentationSidebar","previous":{"title":"Scale Components","permalink":"/docs/components/scale"},"next":{"title":"Console Build","permalink":"/docs/build-setup/console-build"}}');
