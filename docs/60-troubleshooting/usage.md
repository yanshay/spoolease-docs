...
- SpoolEase must be running at the start of the print. If it launches afterward, filament consumption cannot be tracked.
...
- Verify the USB-Stick is functioning properly. The printer can function totally fine w/o a USB-Stick, and when it has certain failure the printer just work without it. Such failure, will prevent SpoolEase from tracking filament consumption.
